          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-6/12">
              <div className="hero-content">
                ...
                <p className="mb-8 max-w-[480px] text-gray-50 text-base text-body-color dark:text-dark-6">
                Health shouldn't be a puzzle,we are cutting 
                through the B.S to bring to you simple ,affordable and
                transperent healthcare.
                </p>
                 {/* SEARCH BAR HERE */}
                 <SearchBar/>
                 {/* CTA BTNS  */}
                  ...
                  <li>
                    <Link
                      ...
                      justify-center rounded-md bg-blue-600 px-6 py-3
                       text-center text-base font-medium text-white hover:bg-blue-700 lg:px-7"
                    >
               ...
               <div className="py-4 pt-8 flex gap-4 ">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <span className="text-sm text-gray-400">Active Specialist</span>
                </div>
                <div className="flex flex-col items-center justify-center">
